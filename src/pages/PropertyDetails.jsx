      ...
      <section>
        <div className="container mx-auto min-h-[800px] mb-14">
          ...
          <div className="flex flex-col items-start gap-8 lg:flex-row">
            ...
            <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-5 py-8">
              ...
              <form className="flex flex-col gap-y-4">
                ...
                <textarea
                  ...
                  placeholder="Message*"
                  defaultValue="Permisi, saya tertarik pada [Modern apartment]"
                ></textarea>
                <div className="flex gap-x-2">
                  <button className="bg-violet-700 hover:bg-violet-800 text-white p-4 rounded text-sm w-full transition">Send message</button>
